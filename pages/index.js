...
const examples = [
  ...
  {
    prompt: "manila runic bricks",
    image:
      "https://replicate.delivery/pbxt/tbYd1YD0gN4uJtbg13VJ3DXRdRzb2AerbADk07rIH7fvU2cQA/out-0.png",
    predictionId: "he5sdal2sjh6rllddojmufnclm",
  },
  {
    prompt: "hearts",
    image:
      "https://replicate.delivery/pbxt/71c67ZGgdlqMLVLj1ubUzrTVLbMI9efwhsOVSuWWGXPKX2cQA/out-0.png",
    predictionId: "is6zaytjabajzj2ida2q7cbdey",
  },
  {
    prompt: "surface of earth",
    image:
      "https://replicate.delivery/pbxt/Dhf5XVzPifpS2UDIIUR7Bog0ONjfcnYah1C3jACH4BYjws5gA/out-0.png",
    predictionId: "tl3fimoswzgtfdcuf56xeo6dvq",
  },
  {
    prompt:
      "Mossy Runic Bricks seamless texture, trending on artstation, stone, moss, base color, albedo, 4k",
    image:
      "https://replicate.delivery/pbxt/uzwfaMNDRvUmMKBDW41wg1WSxInlWiI7WfHrszVy6Ume3v5gA/out-0.png",
    predictionId: "srchxnybzje2ndeoexbfm6otxa",
  },
];
    ...
    <>
      <div className="relative overflow-hidden h-screen bg-black">
        ...
        <div className="animate-rise z-30 fixed bottom-3 right-0 text-gray-300 bg-dark text-xs p-3 rounded-l-lg">
          <p>
            Copyright © 2023{" "}
            <a className="hover:underline text-white" href="https://llego.dev/">
              Mark Anthony Llego
            </a>
          </p>
        </div>
        ...
        >
          <fieldset>
            ...
            <div className="mt-2">
              ...
              <a
                id="inspire-button"
                href="https://github.com/llegomark/tilemaker"
                type="button"
              ...
              >
                ...
                TileMaker - the revolutionary AI-powered tool that transforms
                text into stunning tiling images with just a few clicks. &rarr;
              </a>
            </div>
          </fieldset>
        </form>
            ...
            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm mx-auto sm:p-6">
              ...
              <div className="window-body mt-4">
                <fieldset className="space-y-3">
                  <p>
                    Are you tired of spending countless hours creating tiling
                    images for your website or project? Well, look no further!
                    Introducing TileMaker - the revolutionary AI-powered tool
                    that transforms text into stunning tiling images with just a
                    few clicks.
                  </p>

                  <p>
                    With TileMaker, you can say goodbye to the time-consuming
                    and tedious process of manual image creation. Simply enter
                    your desired text, choose a style and color scheme, and let
                    our AI technology do the rest. You&apos;ll be amazed at the
                    beautiful and unique tiling images that are generated in a
                    matter of seconds!
                  </p>
